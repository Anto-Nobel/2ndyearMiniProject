...
String serverName="https://unspoilt-compounds.000webhostapp.com/tele.php?api_key=jdhvbgsdjvhsdbcvjyegfdmsdcvh1278ewqndb23dbu";
...
void loop() {
  ...
  if(millis()>=Reqdelay+prevMillis)
  {
    ...
    WiFiClient client;
    HTTPClient http; 
    //http.begin("https://unspoilt-compounds.000webhostapp.com/tele.php") ; 
